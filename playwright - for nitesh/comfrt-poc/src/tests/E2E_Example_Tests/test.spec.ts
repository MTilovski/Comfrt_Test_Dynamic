...
// Navigate to a specific category    
    ...
    await helpers.writeTextToCSV(PLPage.MAIN_TITLE,'category_title_store.csv');
});    

// npx playwright test comfrt-poc/src/tests/E2E_Example_Tests/test.spec.ts --headed --reporter=html